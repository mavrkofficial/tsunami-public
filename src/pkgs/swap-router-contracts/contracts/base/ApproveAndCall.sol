...
import '@uniswap/v3-periphery/contracts/interfaces/ITsunamiV3PositionManager.sol';

import '../interfaces/IApproveAndCall.sol';
import './ImmutableState.sol';

/// @title Approve and Call
/// @notice Allows callers to approve the Tsunami V3 position manager from this contract,
...
abstract contract ApproveAndCall is IApproveAndCall, ImmutableState {
        ...
        return
            callPositionManager(
                abi.encodeWithSelector(
                    ITsunamiV3PositionManager.mint.selector,
                    ITsunamiV3PositionManager.MintParams({
        ...
        returns (bytes memory result)
    {
        return
            callPositionManager(
                abi.encodeWithSelector(
                    ITsunamiV3PositionManager.increaseLiquidity.selector,
                    ITsunamiV3PositionManager.IncreaseLiquidityParams({
