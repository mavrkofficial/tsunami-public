...
import {TsunamiImmutables, TsunamiParameters} from './modules/uniswap/TsunamiImmutables.sol';
...
contract UniversalRouter is IUniversalRouter, Dispatcher, RewardsCollector {
    ...
    constructor(RouterParameters memory params)
        TsunamiImmutables(
            TsunamiParameters(params.v2Factory, params.v3Factory, params.pairInitCodeHash, params.poolInitCodeHash)
        )
