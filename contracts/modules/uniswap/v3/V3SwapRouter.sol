...
import {ITsunamiV3Pool} from '@uniswap/v3-core/contracts/interfaces/ITsunamiV3Pool.sol';
import {ITsunamiV3SwapCallback} from '@uniswap/v3-core/contracts/interfaces/callback/ITsunamiV3SwapCallback.sol';
...
/// @title Router for Tsunami V3 Trades
abstract contract V3SwapRouter is TsunamiImmutables, Permit2Payments, ITsunamiV3SwapCallback {
    ...
    /// @notice Performs a Tsunami V3 exact input swap
    ...
    /// @notice Performs a Tsunami V3 exact output swap
    /// @param recipient The recipient of the output tokens
        ...
        returns (int256 amount0Delta, int256 amount1Delta, bool zeroForOne)
    {
        ...
        (amount0Delta, amount1Delta) = ITsunamiV3Pool(computePoolAddress(tokenIn, tokenOut, fee)).swap(
            recipient,
            zeroForOne,
            amount,
                ...
                uint256(
                    keccak256(
                        abi.encodePacked(
                            ...
                            TSUNAMI_V3_POOL_INIT_CODE_HASH
                        )
                    )
                )
            )
