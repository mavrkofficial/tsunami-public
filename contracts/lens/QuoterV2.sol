...
import '@uniswap/v3-core/contracts/interfaces/callback/ITsunamiV3SwapCallback.sol';

import '../interfaces/ITsunamiQuoterV2.sol';
...
contract TsunamiQuoterV2 is ITsunamiQuoterV2, ITsunamiV3SwapCallback, PeripheryImmutableState {
    using Path for bytes;
    using SafeCast for uint256;
    using PoolTicksCounter for ITsunamiV3Pool;
    ...
    function getPool(
        ...
        address tokenB,
        uint24 fee
    ) private view returns (ITsunamiV3Pool) {
        return ITsunamiV3Pool(PoolAddress.computeAddress(factory, PoolAddress.getPoolKey(tokenA, tokenB, fee)));
    }

    /// @inheritdoc ITsunamiV3SwapCallback
    function uniswapV3SwapCallback(
        ...
        ITsunamiV3Pool pool = getPool(tokenIn, tokenOut, fee);
        ...
        )
    {
        ...
        ITsunamiV3Pool pool = getPool(params.tokenIn, params.tokenOut, params.fee);
